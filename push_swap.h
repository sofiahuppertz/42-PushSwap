...
/*   Updated: 2023/09/02 20:24:52 by shuppert         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				calculate_quantile_bounds(int quantile_bounds[5],
						int *sorted_copy, int size);
...
void				handle_mixed_moves(t_data **stack_a, t_data **stack_b,
						int moves_a, int moves_b);
void				handle_negative_moves(t_data **stack_a, t_data **stack_b,
						int moves_a, int moves_b);
void				handle_positive_moves(t_data **stack_a, t_data **stack_b,
						int moves_a, int moves_b);
...
void				perform_rotations(t_data **stack_a, t_data **stack_b,
						int moves_a, int moves_b);
...
void				set_holds(int *first_hold, int *last_hold, t_data **stack_a,
						int bound);
void				set_inital_params(int *first_hold, int *last_hold);
void				set_pos(t_data *current, t_data **stack_b);
void				sort_numbers(t_data **stack_a, t_data **stack_b,
						int **sorted_copy, int size);
